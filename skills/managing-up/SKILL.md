...
- `managing-yourself` — The 10 ways EMs get stuck includes traps #8–10 on managing up and down
- `influence` — For persuading peers, cross-functional stakeholders, and getting headcount
- `feedback` — Giving feedback to your manager is a specific case of the feedback skill
